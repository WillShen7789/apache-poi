package com.acer.soms.excel.spsalesamountdata;
...
public class SPSalesAmountDataCreator {

	static final String SOURCE_DIR = "src\\main\\resources\\source\\enhancement\\spsalesamountanalysis";
	static final String TEMPLATE_NAME = "source/enhancement/spsalesamountanalysis/SP Sales Amount Data Source.xlsx";
...
//    	this.setDataToSheet(tVos);
	...
	private List<Object[]> getData() throws IOException {
		List<Object[]> result = new ArrayList<Object[]>();
		InputStream template = this.getClass().getClassLoader().getResourceAsStream(TEMPLATE_NAME);
		Workbook workbook = new XSSFWorkbook(template);
		Sheet sourceDataSheet = workbook.getSheet("SP Sales Amount Data Source");
